...
})({"2Ef3G":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
const renderCards = (articles)=>{
    ...
    } else heroBannerContent.innerHTML = 'no articles sorry';
};
const renderGrid = (articles)=>{
    ...
    } else gridNews.innerHTML = 'no articles sorry';
};
fetchNews(API_KEY);

},{}]},["2Ef3G","hOJOi"], "hOJOi", "parcelRequire94c2")
